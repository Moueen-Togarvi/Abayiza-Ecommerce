<script lang="ts">
	...
	const isActive = (href: string) => {
		...
		if (href === '/abayiza-secure-admin-7k9x2p/orders/completed') return page.url.pathname.startsWith(href);
		if (href === '/abayiza-secure-admin-7k9x2p/orders/cancelled') return page.url.pathname.startsWith(href);
		if (href === '/abayiza-secure-admin-7k9x2p/orders') {
			return page.url.pathname === href || /^\/abayiza-secure-admin-7k9x2p\/orders\/(?!(completed|cancelled))/.test(page.url.pathname);
		}
	...
	<aside class={`fixed inset-y-0 left-0 z-40 flex h-screen w-72 flex-shrink-0 flex-col border-r border-[#000]/10 bg-white transition-all duration-300 md:sticky md:top-0 md:z-20 ${isSidebarOpen ? 'md:w-64' : 'md:w-20'} ${isMobileMenuOpen ? 'translate-x-0' : '-translate-x-full md:translate-x-0'}`}>
		...
		<nav class="flex-1 overflow-y-auto py-4">
			<ul class="space-y-1 px-3">
				<li>
					<a href="/abayiza-secure-admin-7k9x2p" class={`flex items-center rounded-md border-l-4 px-3 py-2 text-sm font-semibold transition-colors ${isActive('/abayiza-secure-admin-7k9x2p') ? 'border-blue-500 bg-[#000] text-white shadow-sm' : 'border-transparent text-[#000]/70 hover:border-blue-500 hover:bg-blue-50 hover:text-[#000]'}`}>
				...
				<li>
					<a href="/abayiza-secure-admin-7k9x2p/orders" class={`flex items-center rounded-md border-l-4 px-3 py-2 text-sm font-semibold transition-colors ${isActive('/abayiza-secure-admin-7k9x2p/orders') ? 'border-orange-500 bg-[#000] text-white shadow-sm' : 'border-transparent text-[#000]/70 hover:border-orange-500 hover:bg-orange-50 hover:text-[#000]'}`}>
				...
				<li>
					<a href="/abayiza-secure-admin-7k9x2p/orders/completed" class={`flex items-center rounded-md border-l-4 px-3 py-2 text-sm font-semibold transition-colors ${isActive('/abayiza-secure-admin-7k9x2p/orders/completed') ? 'border-green-500 bg-[#000] text-white shadow-sm' : 'border-transparent text-[#000]/70 hover:border-green-500 hover:bg-green-50 hover:text-[#000]'}`}>
				...
				<li>
					<a href="/abayiza-secure-admin-7k9x2p/orders/cancelled" class={`flex items-center rounded-md border-l-4 px-3 py-2 text-sm font-semibold transition-colors ${isActive('/abayiza-secure-admin-7k9x2p/orders/cancelled') ? 'border-red-500 bg-[#000] text-white shadow-sm' : 'border-transparent text-[#000]/70 hover:border-red-500 hover:bg-red-50 hover:text-[#000]'}`}>
				...
				<li>
					<a href="/abayiza-secure-admin-7k9x2p/products" class={`flex items-center rounded-md border-l-4 px-3 py-2 text-sm font-semibold transition-colors ${isActive('/abayiza-secure-admin-7k9x2p/products') ? 'border-yellow-500 bg-[#000] text-white shadow-sm' : 'border-transparent text-[#000]/70 hover:border-yellow-500 hover:bg-yellow-50 hover:text-[#000]'}`}>
				...
				<li>
					<a href="/abayiza-secure-admin-7k9x2p/categories" class={`flex items-center rounded-md border-l-4 px-3 py-2 text-sm font-semibold transition-colors ${isActive('/abayiza-secure-admin-7k9x2p/categories') ? 'border-yellow-500 bg-[#000] text-white shadow-sm' : 'border-transparent text-[#000]/70 hover:border-yellow-500 hover:bg-yellow-50 hover:text-[#000]'}`}>
				...
				<li>
					<a href="/abayiza-secure-admin-7k9x2p/reviews" class={`flex items-center rounded-md border-l-4 px-3 py-2 text-sm font-semibold transition-colors ${isActive('/abayiza-secure-admin-7k9x2p/reviews') ? 'border-blue-500 bg-[#000] text-white shadow-sm' : 'border-transparent text-[#000]/70 hover:border-blue-500 hover:bg-blue-50 hover:text-[#000]'}`}>
				...
				<li>
					<a href="/abayiza-secure-admin-7k9x2p/customers" class={`flex items-center rounded-md border-l-4 px-3 py-2 text-sm font-semibold transition-colors ${isActive('/abayiza-secure-admin-7k9x2p/customers') ? 'border-blue-500 bg-[#000] text-white shadow-sm' : 'border-transparent text-[#000]/70 hover:border-blue-500 hover:bg-blue-50 hover:text-[#000]'}`}>
				...
				<li>
					<a href="/abayiza-secure-admin-7k9x2p/users" class={`flex items-center rounded-md border-l-4 px-3 py-2 text-sm font-semibold transition-colors ${isActive('/abayiza-secure-admin-7k9x2p/users') ? 'border-blue-500 bg-[#000] text-white shadow-sm' : 'border-transparent text-[#000]/70 hover:border-blue-500 hover:bg-blue-50 hover:text-[#000]'}`}>
				...
				<li>
					<a href="/abayiza-secure-admin-7k9x2p/discounts" class={`flex items-center rounded-md border-l-4 px-3 py-2 text-sm font-semibold transition-colors ${isActive('/abayiza-secure-admin-7k9x2p/discounts') ? 'border-red-500 bg-[#000] text-white shadow-sm' : 'border-transparent text-[#000]/70 hover:border-red-500 hover:bg-red-50 hover:text-[#000]'}`}>
				...
				<li>
					<a href="/abayiza-secure-admin-7k9x2p/analytics" class={`flex items-center rounded-md border-l-4 px-3 py-2 text-sm font-semibold transition-colors ${isActive('/abayiza-secure-admin-7k9x2p/analytics') ? 'border-orange-500 bg-[#000] text-white shadow-sm' : 'border-transparent text-[#000]/70 hover:border-orange-500 hover:bg-orange-50 hover:text-[#000]'}`}>
			...
			<ul class="space-y-1 px-3">
				<li>
					<a href="/abayiza-secure-admin-7k9x2p/storefront" class={`flex items-center rounded-md border-l-4 px-3 py-2 text-sm font-semibold transition-colors ${isActive('/abayiza-secure-admin-7k9x2p/storefront') ? 'border-yellow-500 bg-[#000] text-white shadow-sm' : 'border-transparent text-[#000]/70 hover:border-yellow-500 hover:bg-yellow-50 hover:text-[#000]'}`}>
		...
		<div class="border-t border-[#000]/10 p-4">
			<a href="/abayiza-secure-admin-7k9x2p/settings" class={`flex items-center rounded-md border-l-4 px-3 py-2 text-sm font-semibold transition-colors ${isActive('/abayiza-secure-admin-7k9x2p/settings') ? 'border-red-500 bg-[#000] text-white shadow-sm' : 'border-transparent text-[#000]/70 hover:border-red-500 hover:bg-red-50 hover:text-[#000]'}`}>
	...
	<div class="flex flex-1 flex-col overflow-hidden">
		...
		<header class="sticky top-0 z-10 flex h-16 items-center justify-between border-b border-[#000]/10 bg-white px-6">
			...
			<div class="ml-4 flex items-center space-x-4 md:ml-6">
				...
				<div class="relative">
					<form method="POST" action="/abayiza-secure-admin-7k9x2p/logout" class="flex items-center gap-3">
