...
<div class="max-w-7xl mx-auto">
	<div class="flex justify-between items-center mb-6">
		...
		<div class="flex space-x-3">
			<a href="/abayiza-secure-admin-7k9x2p/orders/completed" class="rounded-md border border-gray-300 bg-white px-4 py-2 text-sm font-medium text-gray-700 shadow-sm hover:bg-gray-50">
				Completed Orders
			</a>
			<a href="/abayiza-secure-admin-7k9x2p/orders/cancelled" class="rounded-md border border-red-200 bg-red-50 px-4 py-2 text-sm font-medium text-red-700 shadow-sm hover:bg-red-100">
				Cancelled Orders
			</a>
		</div>
	</div>
	...
	<form method="GET" class="rounded-t-lg border-x border-t border-gray-200 bg-white p-4 shadow-sm">
		<div class="grid grid-cols-1 gap-3 md:grid-cols-6">
			...
			<div class="flex gap-2">
				...
				<a href="/abayiza-secure-admin-7k9x2p/orders" class="rounded-md border border-gray-300 px-4 py-2 text-sm font-medium text-gray-600 hover:bg-gray-50">
					Clear
				</a>
			</div>
		</div>
	...
	<div class="bg-white shadow-sm border border-gray-200 rounded-b-lg overflow-x-auto">
		<table class="min-w-full divide-y divide-gray-200">
			...
			<tbody class="bg-white divide-y divide-gray-200">
				...
				<tr class="hover:bg-gray-50 group cursor-pointer" onclick={() => window.location.href = `/abayiza-secure-admin-7k9x2p/orders/${order.id}`}>
